...
:class:`IdentifierInput` from :mod:`gu_toolkit.math_inputs`. This module keeps
...
class MathLiveField(anywidget.AnyWidget):
    ...
    Architecture note
    -----------------
    This API lives in ``gu_toolkit._mathlive_widget`` and participates in the toolkit's canonical identifier, parsing, or semantic math-input infrastructure.
