"""Extended utilities for the notebook prelude.

This module intentionally holds helpers that are not strictly required to
bootstrap the symbol-rich exploratory namespace itself.
"""
