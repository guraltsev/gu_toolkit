...
class SmartFigure:
    ...
    def add_param_change_hook(
        ...
        ----------
        callback:
            Callable invoked as `callback(change)` after the figure re-renders.
        ...
        --------
        Autogenerated ids:
        >>> hid1 = fig.add_param_change_hook(lambda ch: print("changed"))
        >>> hid1
        'hook:1'

        User-specified ids (any hashable key):
        >>> fig.add_param_change_hook(lambda ch: None, hook_id=("analysis", 1))
        ('analysis', 1)

        Collision-safe bump:
        >>> fig.add_param_change_hook(lambda ch: None, hook_id="hook:10")
        'hook:10'
